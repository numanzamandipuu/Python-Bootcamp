...
def save():
    ...
    with open("D:/Python-Bootcamp/Day 29 - Intermediate - Building a Password Manager GUI App with Tkinter/06 - Dialog Boxes and Pop-Ups in Tkinter/data.txt", "a") as file:
...
img_path = PhotoImage(file= "D:/Python-Bootcamp/Day 29 - Intermediate - Building a Password Manager GUI App with Tkinter/06 - Dialog Boxes and Pop-Ups in Tkinter/logo.png")
