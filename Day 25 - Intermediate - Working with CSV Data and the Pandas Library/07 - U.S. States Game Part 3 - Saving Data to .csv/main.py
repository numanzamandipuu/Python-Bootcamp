...
img_path = "D:/Python-Bootcamp/Day 25 - Intermediate - Working with CSV Data and the Pandas Library/07 - U.S. States Game Part 3 - Saving Data to .csv/blank_states_img.gif"
...
data = pandas.read_csv("D:/Python-Bootcamp/Day 25 - Intermediate - Working with CSV Data and the Pandas Library/07 - U.S. States Game Part 3 - Saving Data to .csv/50_states.csv")
